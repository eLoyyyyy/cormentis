...
<div id="em-booking" class="em-booking <?php if( get_option('dbem_css_rsvp') ) echo 'css-booking'; ?>">
	...
	<?php else: ?>
		...
		<?php if( $tickets_count > 0) : ?>
			...
			<form class="form-horizontal em-booking-form" name='booking-form' method='post' action='<?php echo apply_filters('em_booking_form_action_url',''); ?>#em-booking'>
				...
				<?php if( $can_book ): ?>
					<div class=''>
						...
						<div class="em-booking-buttons">
							...
							<input type="submit" class="em-booking-submit btn btn-inverted btn-default" id="em-booking-submit" value="<?php echo esc_attr(get_option('dbem_bookings_submit_button')); ?>" />
							<?php endif; ?>
						</div>
